...
import ListHospitalScreen from "../Entities/Hospital/List.hospital.screen";
import ShowHospitalScreen from "../Entities/Hospital/Show.hospital.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListHospitalScreen"
            component={ListHospitalScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowHospitalScreen"
          component={ShowHospitalScreen}
          options={screenOptions}
        />
